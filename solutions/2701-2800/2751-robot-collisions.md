...
先按位置排序，保证机器人按从左到右的顺序处理。遍历时用栈保存所有向右移动、且还可能和后续机器人发生碰撞的机器人编号；遇到向左移动的机器人时，不断和栈顶向右机器人比较健康度并模拟碰撞，直到当前机器人被消灭、栈顶被消灭，或者当前机器人不再有可碰撞对象。这样每个机器人最多进栈出栈一次，最终保留健康度大于 0 的机器人即可。
