# 分享丨【算法题单】数学算法（数论/组合/概率期望/博弈/计算几何/随机算法） - 讨论 - 力扣（LeetCode）
...
- [2338. 统计理想数组的数目](https://leetcode.cn/problems/count-the-number-of-ideal-arrays/) 2615 可以用 Min_25 筛优化
...
- [2169. 得到 0 的操作数](https://leetcode.cn/problems/count-operations-to-obtain-zero/) 非暴力做法
...
- [3725. 统计每一行选择互质整数的方案数](https://leetcode.cn/problems/count-ways-to-choose-coprime-integers-from-rows/) 倍数容斥
...
- [2470. 最小公倍数为 K 的子数组数目](https://leetcode.cn/problems/number-of-subarrays-with-lcm-equal-to-k/) logTrick 做到 $\mathcal{O}(n\log k)$
...
- [1925. 统计平方和三元组的数目](https://leetcode.cn/problems/count-square-sum-triples/) 本原勾股数组

### §1.11 其他

- [1018. 可被 5 整除的二进制前缀](https://leetcode.cn/problems/binary-prefix-divisible-by-5/) 1376
- [326. 3 的幂](https://leetcode.cn/problems/power-of-three/) 做到 $\mathcal{O}(1)$
- [1387. 将整数按权重排序](https://leetcode.cn/problems/sort-integers-by-the-power-value/) 1507 考拉兹猜想 冰雹猜想
- [372. 超级次方](https://leetcode.cn/problems/super-pow/) 欧拉定理
- [1015. 可被 K 整除的最小整数](https://leetcode.cn/problems/smallest-integer-divisible-by-k/) 欧拉定理、欧拉函数
- [3790. 最小全 1 倍数](https://leetcode.cn/problems/smallest-all-ones-multiple/) 同 1015 题
...
- [1617. 统计子树中城市之间最大距离](https://leetcode.cn/problems/count-subtrees-with-max-distance-between-cities/) 做到 $\mathcal{O}(n^3)$
...
- [762. 二进制表示中质数个计算置位](https://leetcode.cn/problems/prime-number-of-set-bits-in-binary-representation/) 非暴力做法
...
- [3395. 唯一中间众数子序列 I](https://leetcode.cn/problems/subsequences-with-a-unique-middle-mode-i/) 2800 做到 $\mathcal{O}(n)$ 时间
- [1575. 统计所有可行路径](https://leetcode.cn/problems/count-all-possible-routes/)
- [3251. 单调数组对的数目 II](https://leetcode.cn/problems/find-the-count-of-monotonic-pairs-ii/) 做到 $\mathcal{O}(n)$ 时间
...
关于计数 DP 的题目，见 [动态规划题单](https://leetcode.cn/circle/discuss/tXLS3i/) 的「**§7.7 计数 DP**」。
...
- [3669. K 因数分解](https://leetcode.cn/problems/balanced-k-factor-decomposition/) 不是组合数学题，但分析算法的计算量需要用到组合数学
...
- [920. 播放列表的数量](https://leetcode.cn/problems/number-of-music-playlists/) 更快的做法
...
- [812. 最大三角形面积](https://leetcode.cn/problems/largest-triangle-area/) 旋转卡壳
...
- [866. 回文质数](https://leetcode.cn/problems/prime-palindrome/) 1938
- [3766. 将数字变成二进制回文数的最少操作](https://leetcode.cn/problems/minimum-operations-to-make-binary-palindrome/) 非暴力做法
...
- [3102. 最小化曼哈顿距离](https://leetcode.cn/problems/minimize-manhattan-distances/) 2216 曼哈顿距离 $\to$ 切比雪夫距离
...
- [611. 有效三角形的个数](https://leetcode.cn/problems/valid-triangle-number/) 做到 $\mathcal{O}(n+U\log U)$
- [923. 三数之和的多种可能](https://leetcode.cn/problems/3sum-with-multiplicity/) 做到 $\mathcal{O}(n+U\log U)$
...
- [259. 较小的三数之和](https://leetcode.cn/problems/3sum-smaller/)（会员题）做到 $\mathcal{O}(n+U\log U)$
...
- [1502. 判断能否形成等差数列](https://leetcode.cn/problems/can-make-arithmetic-progression-from-sequence/) 做到 $\mathcal{O}(n)$
...
- [390. 消除游戏](https://leetcode.cn/problems/elimination-game/) 类似 3782 题
- [972. 相等的有理数](https://leetcode.cn/problems/equal-rational-numbers/) 2121
- [1515. 服务中心的最佳位置](https://leetcode.cn/problems/best-position-for-a-service-centre/) 2157 凸优化 梯度下降法
