...
- [1652. 拆炸弹](https://leetcode.cn/problems/defuse-the-bomb/) 做到 $\mathcal{O}(n)$
...
- [1016. 子串能表示从 1 到 N 数字的二进制串](https://leetcode.cn/problems/binary-string-with-substrings-representing-1-to-n/) 做到 $\mathcal{O}(|s|)$
...
- [3795. 不同元素和至少为 K 的最短子数组长度](https://leetcode.cn/problems/minimum-subarray-length-with-distinct-sum-at-least-k/) 1505
- [2904. 最短且字典序最小的美丽子字符串](https://leetcode.cn/problems/shortest-and-lexicographically-smallest-beautiful-string/) 做到 $\mathcal{O}(n^2)$
...
- [3258. 统计满足 K 约束的子字符串数量 I](https://leetcode.cn/problems/count-substrings-that-satisfy-k-constraint-i/) 做到 $\mathcal{O}(n)$
...
- [3325. 字符至少出现 K 次的子字符串 I](https://leetcode.cn/problems/count-substrings-with-k-frequency-characters-i/) 做到 $\mathcal{O}(n)$
- [2799. 统计完全子数组的数目](https://leetcode.cn/problems/count-complete-subarrays-in-an-array/) 做到 $\mathcal{O}(n)$
...
- [977. 有序数组的平方](https://leetcode.cn/problems/squares-of-a-sorted-array/) 做到 $\mathcal{O}(n)$
...
- [3802. 给纸张涂色的方式数量](https://leetcode.cn/problems/number-of-ways-to-paint-sheets/)（会员题）
...
- [2200. 找出数组中的所有 K 近邻下标](https://leetcode.cn/problems/find-all-k-distant-indices-in-an-array/) 做法不止一种
- [611. 有效三角形的个数](https://leetcode.cn/problems/valid-triangle-number/)
...
- [2540. 最小公共值](https://leetcode.cn/problems/minimum-common-value/) 做到 $\mathcal{O}(n+m)$
- [88. 合并两个有序数组](https://leetcode.cn/problems/merge-sorted-array/) 做到 $\mathcal{O}(n+m)$
- [2570. 合并两个二维数组 - 求和法](https://leetcode.cn/problems/merge-two-2d-arrays-by-summing-values/) 做到 $\mathcal{O}(n+m)$
...
- [925. 长按键入](https://leetcode.cn/problems/long-pressed-name/) 做到 $\mathcal{O}(n+m)$
...
- [844. 比较含退格的字符串](https://leetcode.cn/problems/backspace-string-compare/) 做到 $\mathcal{O}(1)$ 额外空间
- [986. 区间列表的交集](https://leetcode.cn/problems/interval-list-intersections/) 做到 $\mathcal{O}(n+m)$
...
- [2367. 等差三元组的数目](https://leetcode.cn/problems/number-of-arithmetic-triplets/) 做到 $\mathcal{O}(n)$
...
- [3708. 最长斐波那契子数组](https://leetcode.cn/problems/longest-fibonacci-subarray/) 1381 做到 $\mathcal{O}(n)$
...
- [2593. 标记所有元素后数组的分数](https://leetcode.cn/problems/find-score-of-an-array-after-marking-all-elements/) 做到 $\mathcal{O}(n)$
...
- [3773. 最大等长连续字符组](https://leetcode.cn/problems/maximum-number-of-equal-length-runs/)（会员题）
