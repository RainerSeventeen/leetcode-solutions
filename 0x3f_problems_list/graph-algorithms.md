# 分享丨【算法题单】图论算法（DFS/BFS/拓扑排序/基环树/最短路/最小生成树/网络流） - 讨论 - 力扣（LeetCode）
...
- [924. 尽量减少恶意软件的传播](https://leetcode.cn/problems/minimize-malware-spread/) 1869 附思考题
...
- [3778. 排除一个最大权重边的最小距离](https://leetcode.cn/problems/minimum-distance-excluding-one-maximum-weighted-edge/)（会员题）
...
- [2463. 最小移动总距离](https://leetcode.cn/problems/minimum-total-distance-traveled/) 做到 $\mathcal{O}((n+m)\log(n+m))$
