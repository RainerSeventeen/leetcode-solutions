# 分享丨【算法题单】位运算（基础/性质/拆位/试填/恒等式/思维） - 讨论 - 力扣（LeetCode）
...
- [1342. 将数字变成 0 的操作次数](https://leetcode.cn/problems/number-of-steps-to-reduce-a-number-to-zero/) 做到 $\mathcal{O}(1)$
- [476. 数字的补数](https://leetcode.cn/problems/number-complement/) 做到 $\mathcal{O}(1)$
...
- [2595. 奇偶位数](https://leetcode.cn/problems/number-of-even-and-odd-bits/) 做到 $\mathcal{O}(1)$
- [2154. 将找到的值乘以 2](https://leetcode.cn/problems/keep-multiplying-found-values-by-two/) 要求：$\mathcal{O}(n)$ 时间，$\mathcal{O}(1)$ 空间
...
注：下面的部分题目，可以用**滑动窗口+栈**做到更优的 $\mathcal{O}(n)$ 时间复杂度，见 [原理讲解（方法二）](https://leetcode.cn/problems/find-subarray-with-bitwise-or-closest-to-k/solutions/2798206/li-yong-and-de-xing-zhi-pythonjavacgo-by-gg4d/)。
...
- [3145. 大数组元素的乘积](https://leetcode.cn/problems/find-products-of-elements-of-big-array/) 2859 类似钱珀瑙恩数
- [3022. 给定操作次数内使剩余元素的或值最小](https://leetcode.cn/problems/minimize-or-of-remaining-elements-using-operations/) 2918
- [3287. 求出数组中最大序列值](https://leetcode.cn/problems/find-the-maximum-sequence-value-of-array/) 做到 $\mathcal{O}(nU\log U)$，其中 $U=2^7$
...
- [1261. 在受污染的二叉树中查找元素](https://leetcode.cn/problems/find-elements-in-a-contaminated-binary-tree/) 做到 $\mathcal{O}(1)$ 额外空间
