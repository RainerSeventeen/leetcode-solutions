...
- [1512. 好数对的数目](https://leetcode.cn/problems/number-of-good-pairs/) 1161 相当于两数之差等于 $0$
- [2441. 与对应负数同时存在的最大正整数](https://leetcode.cn/problems/largest-positive-integer-that-exists-with-its-negative/) 1168 相当于两数之和等于 $0$
...
- [2815. 数组中的最大数对和](https://leetcode.cn/problems/max-pair-sum-in-an-array/) 非暴力做法
...
- [2905. 找出满足差值条件的下标 II](https://leetcode.cn/problems/find-indices-with-index-and-value-difference-ii/) 1764 思考题：求下标对的个数
...
- [1534. 统计好三元组](https://leetcode.cn/problems/count-good-triplets/) 做到 $\mathcal{O}(n^2)$
...
- [面试题 17.23. 最大黑方阵](https://leetcode.cn/problems/max-black-square-lcci/) 做到 $\mathcal{O}(n^2\log n)$，难度约 2800
...
- [3427. 变长子数组求和](https://leetcode.cn/problems/sum-of-variable-length-subarrays/) 做到 $\mathcal{O}(n)$
...
- [930. 和相同的二元子数组](https://leetcode.cn/problems/binary-subarrays-with-sum/) 1592 同 560 题
...
- [3755. 最大平衡异或子数组的长度](https://leetcode.cn/problems/find-maximum-balanced-xor-subarray-length/) pair
...
- [1442. 形成两个异或相等数组的三元组数目](https://leetcode.cn/problems/count-triplets-that-can-form-two-arrays-of-equal-xor/) 做到 $\mathcal{O}(n)$
...
- [2031. 1 比 0 多的子数组个数](https://leetcode.cn/problems/count-subarrays-with-more-ones-than-zeros/)（会员题）做到 $\mathcal{O}(n)$
- [2950. 可整除子串的数量](https://leetcode.cn/problems/number-of-divisible-substrings/)（会员题）做到 $\mathcal{O}(kn)$，其中 $k=9$。
...
- [3739. 统计主要元素子数组数目 II](https://leetcode.cn/problems/count-subarrays-with-majority-element-ii/) 2090
- [2031. 1 比 0 多的子数组个数](https://leetcode.cn/problems/count-subarrays-with-more-ones-than-zeros/)（会员题）有 $\mathcal{O}(n)$ 做法
...
- [1895. 最大的幻方](https://leetcode.cn/problems/largest-magic-square/) 1781 斜向前缀和 可以优化到 $\mathcal{O}(N^3)$
...
- [1031. 两个无重叠子数组的最大和](https://leetcode.cn/problems/maximum-sum-of-two-non-overlapping-subarrays/) 做到 $\mathcal{O}(n)$
...
- [1292. 元素和小于等于阈值的正方形的最大边长](https://leetcode.cn/problems/maximum-side-length-of-a-square-with-sum-less-than-or-equal-to-threshold/) 1735 可以优化到 $\mathcal{O}(mn)$
...
- [2810. 故障键盘](https://leetcode.cn/problems/faulty-keyboard/) 做到 $\mathcal{O}(n)$
...
[原理讲解](https://www.bilibili.com/video/BV1bM411X72E/)
...
- [2406. 将区间分为最少组数](https://leetcode.cn/problems/divide-intervals-into-minimum-number-of-groups/) 1713 经典题
...
- [3781. 二进制交换后的最大分数](https://leetcode.cn/problems/maximum-score-after-binary-swaps/) 1823 两种方法
...
- [2653. 滑动子数组的美丽值](https://leetcode.cn/problems/sliding-subarray-beauty/) 非暴力做法
...
- [685. 冗余连接 II](https://leetcode.cn/problems/redundant-connection-ii/) 非暴力做法
...
附加模板题：[CF1850H](https://codeforces.com/problemset/problem/1850/H)
...
- [3777. 使子字符串变交替的最少删除次数](https://leetcode.cn/problems/minimum-deletions-to-make-alternating-substring/) 2202 做法不止一种
...
- [3515. 带权树中的最短路径](https://leetcode.cn/problems/shortest-path-in-a-weighted-tree/) 2312 差分树状数组
...
- [60. 排列序列](https://leetcode.cn/problems/permutation-sequence/) 康托展开，可以做到 $\mathcal{O}(n\log n)$
...
- [1850. 邻位交换的最小次数](https://leetcode.cn/problems/minimum-adjacent-swaps-to-reach-the-kth-smallest-number/) 非暴力做法
- [2193. 得到回文串的最少操作次数](https://leetcode.cn/problems/minimum-number-of-moves-to-make-palindrome/) 非暴力做法
...
基础模板代码如下。为方便入门理解，我没有做复杂封装。通用模板代码可以参考 AtCoder Library 的 [segtree.hpp](https://github.com/atcoder/ac-library/blob/master/atcoder/segtree.hpp)。
