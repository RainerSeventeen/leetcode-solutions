...
5. Final validation:
   ...
   - If format errors are reported, attempt to fix the affected files and rerun once.
   - If errors remain after one fix attempt, stop and report failing files + exact errors.
