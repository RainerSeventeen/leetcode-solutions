...
```python
def count_complete_knapsack(nums, target):
    dp = [0] * (target + 1)
    dp[0] = 1
...
- 0799 - 香槟塔 ｜ [LeetCode 链接](https://leetcode.cn/problems/champagne-tower/) ｜ [题解笔记](../solutions/0701-0800/0799-champagne-tower.md)
